<template>
    <div class="sheet-editor">
        <el-row :gutter="20">
            ...
            <el-col :span="4">
                <el-select :disabled="disable" placeholder="select tone" v-model="sheet.tone">
                    <el-option v-for="(item, index) in Object.values(EnumSheetTone)" :label="'1 = ' + item" :value="item" :key="index" />
                </el-select>
            </el-col>
            <el-col :span="4">
            ...
            <el-col :span="4">
                <el-select :disabled="disable" placeholder="select display" v-model="displayMode">
                    <el-option label="display: notes" value="notes" />
                    <el-option label="display: text" value="text" />
                </el-select>
            </el-col>
            <el-col :span="8">
        ...
        <div class="note-list-txt-displayer" v-if="displayMode == 'text'" :style="style_txt" v-html="sheet.toTxt()" />
...
const on_fromtext_dialog_confirm_btn_clicked = () => {
    ...
    new Promise((resolve, reject) => {
        sheet.value.fromTxt(txt.value, txt2notesDefaultLen.value)
        resolve()
    }).then(() => {
